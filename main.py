...
from cgcnn.data import CIFData, CrystalData
...
def get_data_loader(root_dir: Path) -> CrystalData:
...
def main():
    ...
    # * Alternate data loader (testing)
    root_dir = Path(args.data_options[0])
    dataset = get_data_loader(root_dir)
